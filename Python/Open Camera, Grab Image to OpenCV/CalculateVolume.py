...
# #################################################################
def CalculateVolume(path, vintValue, pixPerMMAtZ, imageWidth, imageHeight, auto):
    print("****** Cropping ******")
    ...
    length = "%0.3f" % result_Length
    width = "%0.3f" % result_Width
    height = "%0.3f" % result_Height
    volume = "%0.3f" % volume_in_mm3
